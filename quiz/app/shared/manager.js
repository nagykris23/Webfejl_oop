/**
 * @callback AddCallback lefut egy elem hozzadasanal
 * @param {Question} question a hozzadott elem
 */
class Manager{
    #array;
    ...
    constructor(array = []){
        ...
        this.#selectedAnswer={};
        this.#addCallback = () => {} //nem mindig adunk neki értéket
    }
